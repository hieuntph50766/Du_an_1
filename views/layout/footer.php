                            ...
                            <div class="widget-body">
                                <address class="contact-block">
                                    <ul>
                                        ...
                                        <li><i class="pe-7s-mail"></i> techlap@gmail.com</li>
                                        <li><i class="pe-7s-call"></i> (009) 800 456 789-987</li>
                                    </ul>
                                </address>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="copyright-text text-center">
                            <p>&copy; 2024 <b>Shop TechLap</b> Made with <i class="fa fa-heart text-danger"></i> by <b>Nhóm 6</b></p>
                        </div>
                    </div>
                </div>
            </div>
